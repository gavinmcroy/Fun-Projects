// ==UserScript==
// @name     BestBuy-RefreshNoBot-12900kf
...
((_)_((_)(_)) (_(_())  ((_)_ _ ((_)_ ((_) ((_)_  ((_)(_(_())
 ...
 const ITEM_KEYWORD= "i9-12900KF"; // NO SPACES IN KEYWORD - ONLY ONE WORD
 const CREDITCARD_CVV = "935"; // BOT will run without changing this value.
 const TESTMODE = "No"; // TESTMODE = "No" will buy the card
 const SMS_DIGITS = "8200"; // Enter last 4 digits of phone # for SMS verification
 ...
 const OOS_REFRESH = 8 // (in Seconds) Refresh rate on OOS item.
