/// @description DayCycle Speed and Color Hue
speed_frame = delta_time / 1000000;
time_increment = time_speed * speed_frame;
...
if(hours >= 24){
	...
	//31 Day Reset for + 1 months
	if(day > 30){
		day = 1;
		month=month+1;
	}
	//12 Month reset +1 for year
		if(month>11){
		month=0
		year=year+1
		}
		//Determines Season and displays on HUD
